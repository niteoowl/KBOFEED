export const KBO_TEAMS = [
  ...
  { id: '삼성', file: 'SAMSUNG', shortLabel: '삼성', fullName: '삼성 라이온즈' },
  { id: 'SSG', file: 'SSG', shortLabel: 'SSG', fullName: 'SSG 랜더스' },
  { id: '두산', file: 'DOOSAN', shortLabel: '두산', fullName: '두산 베어스' },
  { id: 'NC', file: 'NC', shortLabel: 'NC', fullName: 'NC 다이노스' },
  { id: '한화', file: 'HANWHA', shortLabel: '한화', fullName: '한화 이글스' },
  { id: '롯데', file: 'LOTTE', shortLabel: '롯데', fullName: '롯데 자이언츠' },
  { id: 'KT', file: 'KT', shortLabel: 'KT', fullName: 'KT 위즈' },
  { id: '키움', file: 'KIWOOM', shortLabel: '키움', fullName: '키움 히어로즈' },
] as const;
